...
type VisitorProp<S, K extends string> = K extends OptionKeys ? TraverseOptions[K] : K extends VisitNodeObjectKeys ? VisitNodeObject<S, t.Node>[K] : VisitNode<S, ToNode<K>>;
